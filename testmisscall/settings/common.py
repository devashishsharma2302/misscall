...
"""
Django settings for testmisscall project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '@zi=a+(0u_lq_md*@uvfw-3&b7y%prq7v!xnf*jzm1!7ef^9cc')
...
ROOT_URLCONF = 'testmisscall.urls'
...
WSGI_APPLICATION = 'testmisscall.wsgi.application'
...
# See .ebextensions/testmisscall.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'testmisscall.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
