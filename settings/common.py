...
"""
Django settings for misscall project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'w(0wde6c%mz7a4m*7aa5_vs!s3jdq7m@(1#q4ddzwm&bn@oogb')
...
WSGI_APPLICATION = 'misscall.wsgi.application'
...
# See .ebextensions/misscall.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'misscall.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
